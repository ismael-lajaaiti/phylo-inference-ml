...
```{r}
saveRDS(sumstat, "data/new-phylogenies-crbd-sumstat.rds")
```
...
```{r}
saveRDS(sumstat, "data/new-phylogenies-crbd-cblv.rds")
```
...
```{r}
saveRDS(sumstat, "data/new-phylogenies-crbd-ltt.rds")
```
...
```{r}
saveRDS(graphs, "data/new-phylogenies-crbd-graph.rds")
```
